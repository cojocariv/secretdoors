...
<section class="max-w-7xl mx-auto px-4 py-20 text-center">
  <div class="mx-auto max-w-2xl" data-reveal>
    <p class="text-sm font-semibold text-black/60 tracking-wide">404</p>
    <h1 class="mt-4 text-5xl font-semibold tracking-tight">Pagina nu a fost găsită</h1>
    <p class="mt-4 text-black/65 leading-relaxed">
